...
public static class CapabilityDefinitionEndpointExtensions
{
    public static IEndpointRouteBuilder MapEnterpriseThreadCapabilityDefinitionEndpoints(this IEndpointRouteBuilder endpoints)
    {
        var group = endpoints.MapGroup("/api/admin/capabilities")
            .RequireAuthorization()
            .WithTags("Capabilities");

        group.MapGet("/", async (
            ICapabilityDefinitionService service,
