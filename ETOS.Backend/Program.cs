...
app.MapEnterpriseThreadGovernanceAnalyticsEndpoints();
...
app.MapEnterpriseThreadDecisionEndpoints();
app.MapEnterpriseThreadOutcomeTaxonomyEndpoints();
app.MapEnterpriseThreadLearningEndpoints();
app.MapEnterpriseThreadDigitalThreadEndpoints();
...
app.MapEnterpriseThreadWorkflowDefinitionEndpoints();
app.MapEnterpriseThreadWorkflowExecutionEndpoints();
app.MapEnterpriseThreadWorkflowRunEndpoints();
