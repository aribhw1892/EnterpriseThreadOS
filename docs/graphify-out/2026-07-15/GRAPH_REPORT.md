# Graph Report - docs  (2026-07-15)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 125 nodes · 143 edges · 24 communities (12 shown, 12 thin omitted)
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.96)
...
3. `EnterpriseThreadPlatform.cs` - 12 edges
4. `ETOS.Backend` - 10 edges
...
Cohesion: 0.10
Nodes (31): Agent Runs Module, Agent Runtime Module, Agents Module, Agent Templates Module, Agent Types Module, AI Trace Module, Artifact Registry Module, Business Policies Module (+23 more)

### Community 1 - "System Architecture and Development"
Cohesion: 0.13
Nodes (17): Program.cs, ETOS.AgentRuntime, ETOS.Backend, Dapr (optional workflow host), dotnet run (backend local run), ETOS.Frontend, PDM ↔ Odoo Identity Linking, import-mapping-assistant Agent (+9 more)

### Community 2 - "Architecture and Development Documentation"
Cohesion: 0.15
Nodes (13): Artifact Registry Module, Classification And Policy Module, Data Quality Issues Module, Document Memory Module, EnterpriseThreadPlatform.cs, Governance And Audit Module, Graph Memory Module, Health Module (+5 more)
...
## Knowledge Gaps
- **65 isolated node(s):** `ETOS.Backend (Platform Core)`, `ModelPackageVersion`, `ReferencePackageManifestLoader`, `Governed Query And Context Assembly Module`, `AI Trace Module` (+60 more)
...
- **Why does `EnterpriseThreadPlatform` connect `Architecture Decisions and AI Workflow` to `System Architecture and Development`, `Architecture and Development Documentation`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `ETOS.Backend` connect `System Architecture and Development` to `Architecture Decisions and AI Workflow`, `Community 6`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `Platform/EnterpriseThreadPlatform.cs` connect `Architecture Decisions and AI Workflow` to `Architecture and Development Documentation`?**
...
- **Are the 7 inferred relationships involving `Docker Compose Infrastructure` (e.g. with `Memgraph (optional graph backend)` and `MinIO Service`) actually correct?**
  _`Docker Compose Infrastructure` has 7 INFERRED edges - model-reasoned connections that need verification._
