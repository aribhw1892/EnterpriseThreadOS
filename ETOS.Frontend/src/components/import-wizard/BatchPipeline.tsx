...
import type { ImportWizardBatchState } from "@/lib/import-wizard/create-import-wizard-actions";
...
type BatchPipelineProps = {
  ...
  batchStates: ImportWizardBatchState[];
};

export function BatchPipeline({ profiles, batchStates }: BatchPipelineProps) {
  return (
