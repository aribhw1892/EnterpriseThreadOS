...
import type { ImportColumnMapping, ImportFileProfile } from "@/lib/import-wizard/import-profile-types";
import { useFormStatus } from "react-dom";

type WizardServerAction = (formData: FormData) => void | Promise<void>;

type MappingCompareProps = {
...
function formatMappingTarget(mapping: ImportColumnMapping) {
...
function presetKey(mapping: ImportColumnMapping) {
...
export function MappingCompare({
  profile,
  aiPreview,
  aiError,
  aiLoading,
    ...
    <div className="grid gap-4">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <section className="rounded-2xl border border-slate-800 bg-slate-950 p-4">
          ...
          <form action={approveMapping} className="mt-4">
